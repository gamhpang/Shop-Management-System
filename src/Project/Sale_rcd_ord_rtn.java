...
public void deleting(String value,String value2) throws SQLException{
	...
	String url ="";
	if(flag4del==2) {url+="delete from sale_return where Customer_id='"+value+"'  and Product_id='"+value2+" ' ";}
	else if(flag4del==0) {url+="delete from sale_order where P_id='"+value+"'  and C_id='"+value2+"'";}
	PreparedStatement ps1=connection.prepareStatement(url);
